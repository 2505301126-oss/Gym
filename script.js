...
const TESTIMONIALS = [
    { name: 'Mr. Mohamad Zaid', role: 'Competitive Powerlifter', rating: 5, text: 'The Olympic barbell I bought from GymForce is absolutely insane quality. Knurl is perfect, spin is smooth. This is commercial-grade at a fraction of the gym price. Highly recommend.', avatar: '💪', verified: true },
    { name: 'Abhishek Sharma', role: 'CrossFit Coach', rating: 5, text: 'The adjustable dumbbells are genius. I cleared half my gym floor using one pair. Quality is excellent and delivery was lightning fast. GymForce is my go-to for all gym purchases.', avatar: '🏋️', verified: true },
    { name: 'Aman Shroti', role: 'Fitness Enthusiast', rating: 5, text: 'Ordered ON Whey and Creatine together. Got discount + free shaker. Products are 100% authentic. The customer support helped me pick the right supplements for my goals.', avatar: '⚡', verified: true },
    { name: 'Bhumi Kumari', role: 'Personal Trainer', rating: 4, text: 'The power rack is a beast. Assembly took a while but the instructions were clear. Rock solid. My clients feel the quality difference immediately. Will definitely order again.', avatar: '🔥', verified: true },
    { name: 'Navdeep Nain', role: 'Marathon Runner', rating: 5, text: 'Bought the treadmill for home use. The whisper-quiet motor is no joke. Even at 18 km/h it\'s barely audible. Best investment I\'ve made for home fitness.', avatar: '🏃', verified: true },
    { name: 'Ayush Sharma', role: 'Yoga & Strength Coach', rating: 5, text: 'Love the foam roller and resistance bands from here. Perfect for my mobility sessions. The foam roller has the right density — not too soft, not too hard. Will reccomend to all clients.', avatar: '🧘', verified: true },
];
